...
export function useAuditFormSchema(): VbenFormSchema[] {
  return [
    { fieldName: 'id', component: 'Input', dependencies: { triggerFields: [''], show: () => false } },
    {
      ...
      label: '审核人',
      component: 'ApiSelect',
      componentProps: { api: getSimpleDoctorList, labelField: 'name', valueField: 'id', placeholder: '请选择组长/审核人' },
...
export function useGridFormSchema(): VbenFormSchema[] {
  return [
    ...
    { fieldName: 'patientName', label: '患者姓名', component: 'Input', componentProps: { allowClear: true, placeholder: '请输入患者姓名' } },
    {
      ...
      label: '审核人',
      component: 'ApiSelect',
      componentProps: { api: getSimpleDoctorList, labelField: 'name', valueField: 'id', allowClear: true, placeholder: '请选择审核人' },
    },
    {
...
export function useGridColumns(): VxeTableGridOptions<HospitalPlanGroupReviewApi.PlanReview>['columns'] {
  return [
    ...
    { field: 'reviewDoctorName', title: '审核人', minWidth: 120 },
    {
      field: 'reviewResult',
      title: '审核结果',
      minWidth: 100,
