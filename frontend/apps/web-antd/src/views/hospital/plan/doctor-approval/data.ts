...
export function useAuditFormSchema(): VbenFormSchema[] {
  return [
    { fieldName: 'id', component: 'Input', dependencies: { triggerFields: [''], show: () => false } },
    {
      ...
      label: '核准医生',
      component: 'ApiSelect',
      componentProps: { api: getSimpleDoctorList, labelField: 'name', valueField: 'id', placeholder: '请选择核准医生' },
      rules: 'selectRequired',
    },
    { fieldName: 'reviewComment', label: '核准意见', component: 'Textarea', componentProps: { rows: 4, placeholder: '请输入核准意见' } },
...
export function useGridFormSchema(): VbenFormSchema[] {
  return [
    { fieldName: 'bizNo', label: '核准单号', component: 'Input', componentProps: { allowClear: true, placeholder: '请输入核准单号' } },
    ...
    { fieldName: 'patientName', label: '患者姓名', component: 'Input', componentProps: { allowClear: true, placeholder: '请输入患者姓名' } },
    {
      ...
      label: '核准医生',
      component: 'ApiSelect',
      componentProps: { api: getSimpleDoctorList, labelField: 'name', valueField: 'id', allowClear: true, placeholder: '请选择核准医生' },
    },
    {
      fieldName: 'reviewResult',
      label: '核准结果',
      component: 'Select',
      componentProps: { options: reviewResultOptions, allowClear: true, placeholder: '请选择核准结果' },
    },
    {
...
export function useGridColumns(): VxeTableGridOptions<HospitalPlanDoctorApprovalApi.PlanReview>['columns'] {
  return [
    { field: 'bizNo', title: '核准单号', minWidth: 170 },
    ...
    { field: 'reviewDoctorName', title: '核准医生', minWidth: 120 },
    {
      field: 'reviewResult',
      title: '核准结果',
      minWidth: 100,
    ...
    { field: 'reviewComment', title: '核准意见', minWidth: 220, showOverflow: 'tooltip' },
    { field: 'reviewTime', title: '核准时间', minWidth: 180, formatter: 'formatDateTime' },
