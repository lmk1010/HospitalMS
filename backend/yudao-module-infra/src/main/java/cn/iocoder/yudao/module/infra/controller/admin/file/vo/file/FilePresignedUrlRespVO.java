...
public class FilePresignedUrlRespVO {
    ...
    @Schema(description = "文件上传 URL", requiredMode = Schema.RequiredMode.REQUIRED,
            example = "https://example.com/presigned-upload.png?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=demo-credential&X-Amz-Date=20240217T123222Z&X-Amz-Expires=600&X-Amz-SignedHeaders=host&X-Amz-Signature=demo-signature")
